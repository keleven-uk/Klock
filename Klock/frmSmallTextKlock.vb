Public Class frmSmallTextKlock
    ...
    Private Sub lblPAST_Click(sender As Object, e As EventArgs) Handles lblPAST.Click
    ...
    Private Sub lblTHREE_Click(sender As Object, e As EventArgs) Handles lblTHREE.Click

    End Sub

    Private Sub lblFOUR_Click(sender As Object, e As EventArgs) Handles lblFOUR.Click

    End Sub

    Private Sub lblFIVE_Click(sender As Object, e As EventArgs) Handles lblFIVE.Click

    End Sub

    Private Sub lblIT_Click(sender As Object, e As EventArgs) Handles lblIT.Click
    ...
    Private Sub lblIS_Click(sender As Object, e As EventArgs) Handles lblIS.Click
    ...
    Private Sub lblTENto_Click(sender As Object, e As EventArgs) Handles lblTENto.Click

    End Sub

    Private Sub lblHALF_Click(sender As Object, e As EventArgs) Handles lblHALF.Click

    End Sub

    Private Sub lblQUARTER_Click(sender As Object, e As EventArgs) Handles lblQUARTER.Click

    End Sub

    Private Sub lblTWENTY_Click(sender As Object, e As EventArgs) Handles lblTWENTY.Click
    ...
    Private Sub lblFIVEto_Click(sender As Object, e As EventArgs) Handles lblFIVEto.Click

    End Sub

    Private Sub lblSIX_Click(sender As Object, e As EventArgs) Handles lblSIX.Click

    End Sub

    Private Sub lblSEVEN_Click(sender As Object, e As EventArgs) Handles lblSEVEN.Click

    End Sub

    Private Sub lblEIGHT_Click(sender As Object, e As EventArgs) Handles lblEIGHT.Click

    End Sub

    Private Sub lblNINE_Click(sender As Object, e As EventArgs) Handles lblNINE.Click

    End Sub

    Private Sub lblTEN_Click(sender As Object, e As EventArgs) Handles lblTEN.Click

    End Sub

    Private Sub lblELEVEN_Click(sender As Object, e As EventArgs) Handles lblELEVEN.Click

    End Sub

    Private Sub lblISH_Click(sender As Object, e As EventArgs) Handles lblISH.Click

    End Sub

    Private Sub lblIN_Click(sender As Object, e As EventArgs) Handles lblIN.Click

    End Sub

    Private Sub lblTHE_Click(sender As Object, e As EventArgs) Handles lblTHE.Click

    End Sub

    Private Sub lblAFTER_Click(sender As Object, e As EventArgs) Handles lblAFTER.Click

    End Sub

    Private Sub lblNOON_Click(sender As Object, e As EventArgs) Handles lblNOON.Click

    End Sub

    Private Sub lblEVENING_Click(sender As Object, e As EventArgs) Handles lblEVENING.Click
    ...
    Private Sub lblMIDNIGHT_Click(sender As Object, e As EventArgs) Handles lblMIDNIGHT.Click

    End Sub

    Private Sub lblTWELVE_Click(sender As Object, e As EventArgs) Handles lblTWELVE.Click

    End Sub

    Private Sub lblMORNING_Click(sender As Object, e As EventArgs) Handles lblMORNING.Click
    ...
    Private Sub StsStrpInfo_ItemClicked(sender As Object, e As ToolStripItemClickedEventArgs) Handles StsStrpInfo.ItemClicked

    End Sub

    Private Sub stsLblTime_Click(sender As Object, e As EventArgs) Handles stsLblTime.Click

    End Sub

    Private Sub StsLblDate_Click(sender As Object, e As EventArgs) Handles StsLblDate.Click

    End Sub

    Private Sub StsLblKeys_Click(sender As Object, e As EventArgs) Handles StsLblKeys.Click

    End Sub

    Private Sub stsLbIdkeTime_Click(sender As Object, e As EventArgs) Handles stsLbIdkeTime.Click
