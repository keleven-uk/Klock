...
Public Class frmClipboardMonitor
    ...
    Private _displayAction As selectAction          '   instance of selectAction, allows different actions to be performed.

    Public Property DisplayAction As selectAction
        Get
        ...
        Try
            Select Case cl.itemType
                ...
                Case "File"                                                                 '   Copies file
                    ...
                    Else
                        DisplayAction.DisplayReminder(itmText & "No Longer Exists", "G", "Clipboard Error")
    ...
    Private Sub CreateClipboardSave()
        ...
        If Not My.Computer.FileSystem.DirectoryExists(dir) Then
            ...
            Catch ex As ArgumentException
                ...
                DisplayAction.DisplayReminder(ex.Message, "G", "Clipboard Error")
            End Try
        End If
    End Sub
